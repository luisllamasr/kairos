export const en = {
  ...
  'onboarding.memoriesVisibility.title': 'Who can see your memories?',
  'onboarding.memoriesVisibility.subtitle': 'You can change this later in Settings.',
  'onboarding.memoriesVisibility.onlyMe': 'Only me',
  'onboarding.memoriesVisibility.friends': 'Friends',
  'onboarding.memoriesVisibility.everyone': 'Everyone',
  ...
  'publicProfile.mutualFriendsCount.one': '{{count}} mutual friend',
  'publicProfile.mutualFriendsCount.other': '{{count}} mutual friends',
  'publicProfile.memoriesList.title': 'Memories',
  'publicProfile.memoriesList.empty': "There aren't any memories to show on this profile yet.",
  'publicProfile.friendsList.title': 'Friends',
  'publicProfile.friendsList.empty': 'This person has no friends yet.',
  'publicProfile.friendsList.error': 'Could not load this friends list. Please try again.',
  'publicProfile.mutualFriendsList.title': 'Mutual friends',
  'publicProfile.mutualFriendsList.empty': 'No mutual friends yet.',
  'publicProfile.mutualFriendsList.error': 'Could not load mutual friends. Please try again.',
  ...
  'settings.privacy': 'Memory visibility',

  'preferences.title': 'Preferences',
  'preferences.subtitle': 'Choose how Kairos looks and which language it uses.',
  ...
  'privacy.title': 'Memory visibility',
  'privacy.subtitle':
    "Controls which of your memories can appear on your own profile. It doesn't affect who can invite you, who can be part of a shared memory, or your friends list.",
  'privacy.back': 'Back',
  'privacy.memoriesVisibility.title': 'Who can see your memories on your profile?',
  'privacy.memoriesVisibility.onlyMe': 'Only me',
  'privacy.memoriesVisibility.friends': 'Friends',
  'privacy.memoriesVisibility.everyone': 'Everyone',
  'privacy.saveChanges': 'Save changes',
  'privacy.error.save': 'Could not save your memory visibility setting. Please try again.',
  ...
  'memories.detail.profileVisibility.title': 'Show on my profile',
  'memories.detail.profileVisibility.hintVisible': 'This memory appears on your profile.',
  'memories.detail.profileVisibility.hintHidden': 'This memory is hidden from your profile.',
  'memories.detail.profileVisibility.hide': 'Hide from my profile',
  'memories.detail.profileVisibility.show': 'Show on my profile',
  ...
  'memories.error.profileVisibility': 'Could not update this setting. Please try again.',
